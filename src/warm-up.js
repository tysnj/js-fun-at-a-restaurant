...
} else console.log(`We need to get some more ${food}.`);
...
var vegetables = ["carrot", "broccoli", "cauliflower", "brussels sprout", "asparagus"];
...
// different fruits.
var fruits = ["apple", "banana", "pear", "kiwi", "orange", "mango", "pineapple"]
